...
hist(steps_sum$steps, main = "Histograma de pasos totales dados por día", 
     xlab = "Pasos totales por día", ylab = "Número de días", 
...
plot(stepsmeaninterval$interval, stepsmeaninterval$steps, ty = "l",
     xlab = "Intervalo de tiempo", ylab = "Promedio de pasos", 
     main = "
Promedio de pasos realizados durante todos los días frente a \ n intervalo de tiempo")
maxsteps_interval <- 
